...
@section('body-title-section')
    @include('backend.includes.body-page-title-two',['parent'=>'Teacher', 'child' =>  isset($teacher) ? "Update" : 'Create',])
@endsection
...
{{--                                </div>--}}
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <textarea name="address" style="height: 100px" id="editor" cols="20" rows="5" class="form-control">{!!isset($teacher)? $teacher->address : '' !!}</textarea>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <br>
                                    <input type="file"  class="form-control-file" multiple name="educational_files[]" />
                                    <br>
...
{{--                                        @endforeach--}}
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <div>
                                        <input type="checkbox" id="switch2" name="status" {{ isset($teacher) && $teacher->status == 0 ? "" : "checked" }} data-switch="success"/>
