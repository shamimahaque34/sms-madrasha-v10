...
class AttendanceController extends Controller
{
    ...
    {
        return view('backend.academic.attendance.manage',[
...
//        return $request;
    ...
    {
        return view('backend.academic.attendance.details',[
            'attendance'=>Subject::where('slug',$slug)->first(),
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('attendances.index')->with('success','Subject Updated successfully');
